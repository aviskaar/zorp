...
Findings are numbered per run: `F<n>` in run 001, `G<n>` in run 002. A
later run should keep going down the alphabet rather than restarting at
F.
...
Open findings carried forward: G1, G2, and G3 from run 002.
